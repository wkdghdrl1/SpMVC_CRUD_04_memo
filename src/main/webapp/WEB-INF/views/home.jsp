...
<link rel="stylesheet" type="text/css"
	href="${rootPath}/resources/css/main.css">
<link rel="stylesheet" type="text/css"
	href="${rootPath}/resources/css/list.css">
<link rel="stylesheet" type="text/css"
	href="${rootPath}/resources/css/button.css">
<link rel="stylesheet" type="text/css"
	href="${rootPath}/resources/css/input.css?ver=20190718">
<link rel="stylesheet" type="text/css"
	href="${rootPath}/resources/css/view.css?ver=20190718">
	...
	<section>
		<c:choose>
			...
			<c:when test="${BODY == 'MEMO_WRITE' }">
				...
				<%@ include file="/WEB-INF/views/body/memo_join.jspf"%>
			</c:when>
		</c:choose>
	</section>
</body>
