...
public class Memocontroller {
	...
	private static final org.slf4j.Logger logger =  LoggerFactory.getLogger(Memocontroller.class);
	...
	public String memo_delete(@RequestParam long mo_seq, Model model) {
